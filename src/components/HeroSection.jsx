    ...
    className="relative min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <div className="container max-w-4xl mx-auto text-center z-10 mt-30 mb-24">
            <div className="space-y-2">
                <h1 className="text-lg md:text-2xl font-bold tracking-tight mt-7">
                ...
                <p className="text-lg md:text-sm text-muted-foreground max-2-2xl mb-10 mx-auto opacity-0 animate-fade-in-delay-3">

        ...
        <div className="container max-w-4xl mx-auto text-center z-10 mt-30 mb-24">
            <div className="space-y-2">
                ...
                <p className="text-sm md:text-2xl text-muted-foreground max-2-2xl mb-10 mx-auto opacity-0 animate-fade-in-delay-3">
                    As a frontend development specialist, I create exceptional web experiences with a focus on modern technologies 
                    like React, Next.js, and Angular. I craft beautiful and functional user interfaces using HTML5, CSS3, Tailwindcss and JavaScript (ES6+), with a strong emphasis on accessibility and a user-centered approach. 
                    I am dedicated to creating innovative solutions and thrive in collaborative team environments.
                </p>
